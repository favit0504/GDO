...
/**
 * <p>Classe Java per filtroServizioBean complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="filtroServizioBean">
 *   &lt;complexContent>
...
@XmlType(name = "filtroServizioBean", namespace = "http://webservices.gdo.equitalia.it/", propOrder = {
    "valori"
})
@XmlSeeAlso({
    FiltroServizioAgenteBean.class,
    FiltroServizioEnteBean.class,
    FiltroServizioUtenteEsternoBean.class,
    FiltroServizioAltriUtentiBean.class
})
public class FiltroServizioBean
