...
<%@ taglib prefix="s" uri="/struts-tags"%>
	<div id="content">
		<div id="innerContent">
			<div class="inner">
				<h3 class="pagetitle">Ricerca Documento</h3>
				<div style="visibility:hidden" id="message">
					...
					<div id="main">		
						...
						<div class="boxform">
        					...
        					<s:form action="documento!ricerca.action" theme="gdo_ext" id="ricerca-documento" name="ricercadocumento" enctype="multipart/form-data" method="POST">
        						<div id="wizard-n">    						        						
				                    <section>
									<div class="content clearfix">										
				
				                        <s:textfield name="documento.titolo" label="Titolo del documento" cssClass="input" size="50" />
				                        
				                        <s:textarea name="documento.descrizione" label="Descrizione del documento" cols="20" rows="3" wrap="true"></s:textarea>
				                        
				                        <s:textfield name="documento.titoloSezione" label="Titolo della sezione associata" cssClass="input" size="50" />
