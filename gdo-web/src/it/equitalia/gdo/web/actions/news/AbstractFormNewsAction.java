...
public abstract class AbstractFormNewsAction extends AbstractNewsAction {
	...
	protected void validaForm() {
		if (news != null) {			
			...
			if (StringUtils.isBlank(testo.replaceAll("&nbsp;", ""))){
				...
				AntiSamy as = new AntiSamy();
				try {
					//antiSamyPolicyObject � thread safe vedi inizializzazione per riferimenti
	...
	throws BusinessException {
		// In fase di inserimento o modifica di una news � possibile impostare il flag "Visualizza come pop up"
